...
<script>
  (function() {
    var cx = '016656741306535874023:we7jv-hgw6k';
...
<div class="j-header">
  <div class="name">
    <h1>Journal of Fluid Flow, Heat and Mass Transfer (JFFHMT)<br><p class="body">ISSN: 2368-6111</p></h1>
    <div class="oalink">
...
<div class="desktop jhead">
  <div class="name">
    <h1>Journal of Fluid Flow, Heat and Mass Transfer (JFFHMT)</h1>
    <div class="issn">
    <p class="body">ISSN: 2368-6111</p>
    <div class="oalink">
    <a href="http://avestia.com/openaccess" target="blank" title="Avestia's Open Access">
          <img src="../img/j-oa.png" border="0" onmouseover="this.src='../img/j-oa-hover.png'" onmouseout="this.src='../img/j-oa.png'" class="j-oa">
    </a>
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "Journal of Fluid Flow, Heat and Mass Transfer (JFFHMT)"; 
  $message = "Thank you for signing up to receive alerts for JFFHMT - Journal of Fluid Flow, Heat and Mass Transfer.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to JFFHMT - Journal of Fluid Flow, Heat and Mass Transfer. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
